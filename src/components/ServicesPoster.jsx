      ...
      <section className="bg-blue-50 flex flex-wrap xl:flex-nowrap gap-5 xl:gap-20 px-5 md:px-20 py-20 items-center">
        ...
        <div className="w-full xl:w-1/2 flex flex-col justify-center">
          ...
          <ul className="text-lg text-black space-y-4">
            ...
            <li className="text-2xl text-black">
              <strong>Borehole Drilling & Flushing: </strong>
              Professional borehole drilling, maintenance, and water system
              flushing.
            </li>
            <li className="text-2xl text-black">
              <strong>Home Fumigation: </strong>
              Safe and effective pest control solutions for a cleaner, healthier
              home.
            </li>
            <li className="text-2xl text-black">
              <strong>Housing Agent Services: </strong>
              Property management, rentals, and real estate assistance.
            </li>
          </ul>
        </div>
      </section>
