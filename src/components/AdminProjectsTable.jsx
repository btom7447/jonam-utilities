...
export default function AdminProjectsTable({ data = [], onEdit, onDelete }) {
        ...
        <tbody>
          {currentData.map((row, idx) => (
            ...
            >
              ...
              {/* Name */}
              <td className="p-5 border-b border-gray-200 text-left text-gray-900">{row.name}</td>
        ...
        <AdminDataUpdate
          ...
          formFields={[
            ...
            { name: "date", label: "Date", type: "date" },
            {
              ...
              label: "Status",
              type: "select",
              options: ["publish", "draft", "archived"],
            },
          ]}
        />
      )}
