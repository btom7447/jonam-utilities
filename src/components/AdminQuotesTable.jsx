      ...
      <table className="w-full border-collapse">
        <thead className="bg-brown text-white text-left">
          <tr>
            ...
            <th className="p-5 font-semibold">Service Type</th>
            ...
            <tr key={row._id} className="border-b hover:bg-gray-50">
              ...
              <td className="p-5">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{row.email_address}</p>
                </div>
              </td>
              <td className="p-5">{row.phone_number}</td>{" "}
              <td className="p-5">
                {new Date(row.createdAt).toLocaleDateString()}
              </td>
              <td className="p-5 capitalize">{row.service_type}</td>
              {/* Status badge */}
              <td className="p-5">
                <span
