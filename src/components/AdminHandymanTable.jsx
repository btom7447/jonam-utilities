...
export default function AdminHandymanTable({
  data = [],
  onEdit,
  onDelete,
  updating,
    ...
    <section className="mx-5 lg:mx-10 mb-10 bg-white rounded-xl border border-gray-200 overflow-x-auto relative">
        ...
        <tbody>
          {currentData.map((row, idx) => (
            ...
            >
              ...
              <td className="p-5 border-b border-gray-200">{row.name}</td>
              ...
              <td className="p-5 border-b border-gray-200">{row.gigs ?? 0}</td>
      ...
      <div className="flex justify-end items-center gap-10 p-10">
        <button
          ...
          className="flex items-center justify-center gap-1 px-3 py-2 disabled:opacity-50"
        >
